...
public class CircularProgressBar extends View {
    ...
    private int color = ContextCompat.getColor(getContext(), R.color.rippel_color);
    private int back_color = ContextCompat.getColor(getContext(), R.color.cancel_ride_color);
    private RectF rectF;
