...
public class Help extends Fragment implements View.OnClickListener {
    ...
    private HelpFragmentInterface listener;

    public Help() {
        // Required empty public constructor
    }

    public interface HelpFragmentInterface {
        void onBackClick();
    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (HelpFragmentInterface) context;
...
//                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URLHelper.HELP_REDIRECT_URL));
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(URLHelper.HELP_WEB_URL));
