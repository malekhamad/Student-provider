...
import com.astudent.partner.Listener.AdapterImageUpdateListener;
...
public class RegisterDocAdapter extends RecyclerView.Adapter<RegisterDocAdapter.ViewHolder> implements AdapterImageUpdateListener {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (serviceListModel.getImg() != null && !serviceListModel.getImg().equalsIgnoreCase("null") && serviceListModel.getImg().length() > 0) {
            Log.e(TAG, "onBindViewHolder: " + URLHelper.BASE_URL + "/storage/" + serviceListModel.getImg());
            Picasso.with(context).load(URLHelper.BASE_URL + "/storage/" + serviceListModel.getImg()).memoryPolicy(MemoryPolicy.NO_CACHE).placeholder(R.drawable.doc_placeholder).error(R.drawable.doc_placeholder).into(holder.docImg);
        }
    ...
    private void showDialog(final Document document) {
        ...
        viewTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("image", URLHelper.BASE_URL + "/storage/" + document.getImg());
