package com.astudent.partner.Constant;

public class URLHelper {

    //Application WEB Connectivity Details
    public static final String BASE_URL = "https://astudenttutoring.com";
    public static final int CLIENT_ID = 2;
    public static final String CLIENT_SECRET_KEY = "poQH9vRaIuyuKqM2rgL8T4RcZ9OoQHxD1niXymbs";
    public static final String APP_LINK = "https://play.google.com/store/apps/details?id=com.cultor.partner";
    //Help
    ...
    public static final String REVOLUTION_URL = "http://campustutr.com/proregistration/";
    public static final String HELP_WEB_URL = BASE_URL + "/help";
